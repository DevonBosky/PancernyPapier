  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-6 sm:p-12 bg-gradient-to-b from-slate-50 to-slate-100">
      <div className="w-full max-w-5xl">
        ...
        <div className="bg-white p-6 sm:p-8 rounded-xl shadow-xl border border-gray-100 mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-gray-800">Jak przebiega konsultacja?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-lg font-medium text-gray-800 mb-2">1. Wybór terminu</h3>
              <p className="text-gray-600">Wybierz prawnika i dogodny termin konsultacji, który pasuje do Twojego harmonogramu.</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-lg font-medium text-gray-800 mb-2">2. Potwierdzenie</h3>
              <p className="text-gray-600">Otrzymasz email z potwierdzeniem terminu oraz linkiem do spotkania online.</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-lg font-medium text-gray-800 mb-2">3. Konsultacja</h3>
              <p className="text-gray-600">W umówionym terminie połączysz się z prawnikiem, który odpowie na Twoje pytania.</p>
            </div>
          </div>
        </div>
      </div>
